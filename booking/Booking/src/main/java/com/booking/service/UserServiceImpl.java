...
//to get autogenerated id
	...
	// To Send An Email After Booking the Flight Ticket
    public void sendEmail(long pnrNo) throws AddressException {
        ...
        final Email email = DefaultEmail.builder().from(new InternetAddress("potnuru.teju531@gmail.com"))
                .replyTo(new InternetAddress("potnuru.teju531@gmail.com"))
                .to(Lists.newArrayList(new InternetAddress("potnuru.teju531@gmail.com"))).subject("Your Flight is booked")
