...
public class SearchServiceImpl implements SearchService
{
	...
	public List<FlightDetails> findByStartPointAndEndPointAndFlightDate(@PathVariable String startPoint, @PathVariable String endPoint, @PathVariable LocalDate flightDate) {
